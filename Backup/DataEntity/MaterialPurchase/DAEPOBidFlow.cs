...
namespace DataEntity
{
	...
	/// </summary>
	public class DAEPOBidFlow : DAEBase
	{
...
//		}
		...
		{
			int state = (int)mrState;
			String strSql = " Select IDKey , VendorName From Vendor Where Vendor.IDKey in(Select VendorID From MR_BIDSummary Where BIDEvaluationID = '" + bidEvaluationValue + "' And ISAwarded=1 And Status >=" + state+ ")";
			DataTable dt = _da.GetDataTable ( strSql );
			return dt ; 
		}
		...
		{
			String strSql = " Select MR_QuotationPrice.IncotermsID ,WH_BT_Incoterms.IDKey as IncotermsKey , WH_BT_Incoterms.TypeDescription as IncotermsValue ,  MR_QuotationPrice.ShipID ,WH_BT_TransportMethod.IDKey as ShipKey , " +
							" WH_BT_TransportMethod.TypeDescription as ShipValue ,  MR_QuotationPrice.PaymentTypeID ,BT_Payments.IDKey as PaymentsKey ,BT_Payments.TypeDescription as PaymentsValue , " + 
							" MR_QuotationPrice.TransportTermID ,WH_BT_TransportTerm.IDKey as TransportTermKey,WH_BT_TransportTerm.TypeDescription as TransportTermValue ,  MR_QuotationPrice.EmployeeID ,BI_Employee.IDKey as EmployeeKey , " +
							" BI_Employee.FullName as EmployeeValue " + 
							" From MR_QuotationPrice Inner Join MR_BIDEvaluation On MR_QuotationPrice.EnquiryPriceID = MR_BIDEvaluation.EnquiryPriceID Left Join WH_BT_Incoterms On MR_QuotationPrice.IncotermsID = WH_BT_Incoterms.IDKey " + 
							...
							" Left Join BI_Employee On MR_QuotationPrice.EmployeeID = BI_Employee.IDKey" + 
							" Inner Join Vendor On MR_QuotationPrice.VendorNo = Vendor.VendorNo " + 
							" Where MR_BIDEvaluation.BIDEvaluationID = '" + bidEvaluationValue + "' And Vendor.IDKey = '" + vendorID + "'" ;
			DataTable dt = _da.GetDataTable ( strSql );
			return dt ;
		}
	}
