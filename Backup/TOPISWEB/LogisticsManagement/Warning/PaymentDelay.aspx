<%@ Page language="c#" Codebehind="PaymentDelay.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.LogisticsManagement.Warning.PaymentDelay" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table2" cellSpacing="1" cellPadding="1" width="95%" border="0" align="center">
				<TBODY>
					<TR vAlign="top">
						<TD>
							<P><uc1:UCList id="ucList_PaymentDelay" runat="server"></uc1:UCList></P>
						</TD>
					</TR>
					<TR vAlign="top">
