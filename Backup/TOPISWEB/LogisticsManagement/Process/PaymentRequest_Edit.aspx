...
<%@ Page language="c#" Codebehind="PaymentRequest_Edit.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.LogisticsManagement.Process.PaymentRequest_Edit" %>
...
<HTML>
  <HEAD>
		<title>PaymentRequest_Edit</title>
					...
					<TD style="HEIGHT: 55px"></FONT><msp:tabcontrol id="TabControl1" runat="server" BorderColor="Red" BackColor="#FF8080" Width="800px">
							<msp:TabPage ID="tabPage1">
								<TABLE id="Tblucvoucheredit" cellSpacing="1" cellPadding="1" width="100%" border="0" align="center">
									<TR vAlign="top">
										<TD align="center">
											<uc1:ucedit runat="server" ID="ucEdit_PaymentRequest"></uc1:ucedit>
										</TD>
									</TR>
									<TR vAlign="top">
						                <TD>
							                <uc1:UCList id="ucList_PaymentRequest" runat="server"></uc1:UCList>
						                </TD>
					                </TR>
					                <TR vAlign="top">
					                    <TD class="StatusLine" vAlign="right">
						                    <asp:label id="lblTotal" runat="server" Visible="False"  Font-Bold="true"></asp:label></TD>
				                    </TR>
									</TABLE>
							</msp:TabPage>
						</msp:tabcontrol></TD>
