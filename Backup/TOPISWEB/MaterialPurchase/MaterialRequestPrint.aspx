<%@ Page language="c#" Codebehind="MaterialRequestPrint.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.MaterialPurchase.MaterialRequestPrint" %>
...
function printBase() {
window.alert("aaa");
factory.printing.footer = "&b ScriptX 打印 &b"
