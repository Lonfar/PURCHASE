<%@ Page language="c#" Codebehind="QuotationEdit.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.MaterialPurchase.QuotationEdit" %>
							...
							<msp:tabcontrol id="TabControl1" runat="server" BorderColor="Red" BackColor="#FF8080" Width="800px">
								<MSP:TABPAGE id="tabPage1">
									<TABLE id="Tblucvoucheredit" cellSpacing="1" cellPadding="1" width="100%" align="center"
										...
										<tr>
											<td align="right">
												<ASP:BUTTON id="btnRelateQuotation" Runat="server" CausesValidation="False"></ASP:BUTTON>
												<ASP:BUTTON id="btnQuotationEnd" Runat="server" CausesValidation="False"></ASP:BUTTON>
											</td>
										</tr>
										<TR vAlign="top">
											<TD align="center">
												<UC1:UCEDIT id="ucEdit_Quotation" runat="server"></UC1:UCEDIT>
											</TD>
										</TR>
										<TR>
											<TD height="25"></TD>
								...
								<MSP:TABPAGE id="tabPage2">
									<TABLE id="Tblucvoucheredit" cellSpacing="2" cellPadding="2" width="99%" align="center"
										...
										<TR>
											<TD align="right">
												<ASP:BUTTON id="btnCalculate" Runat="server" CausesValidation="False"></ASP:BUTTON>
											</TD>
										</TR>
										<TR vAlign="bottom" align="center">
											<TD align="center" width="95%" colSpan="2">
												<UC1:CHILDEDITCONTROL id="CEdit_QuotationMaterial" runat="server"></UC1:CHILDEDITCONTROL>
											</TD>
										</TR>
										<tr valign="top">
											<td align="right" colspan="2">
												<asp:Label ID="lbCalculate" Runat="server"></asp:Label>
											</td>
										</tr>
									</TABLE>
								</MSP:TABPAGE>
