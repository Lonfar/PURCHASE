...
<%@ Page language="c#" Codebehind="BIDEvaluationPrint.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.MaterialPurchase.BIDEvaluationPrint" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>BIDEvaluationPrint</title>
	...
	<body MS_POSITIONING="FlowLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="95%" border="0" align="center">
				<TBODY>
					<TR>
						<TD colspan="2" align="center" width="50%"><uc3:CrystalReportBar id="CrystalReportBar1" ReportViewer="CrystalReportViewer1" runat="server"></uc3:CrystalReportBar></TD>
