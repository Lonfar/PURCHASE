<%@ Page language="c#" Codebehind="POBidFlow.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.MaterialPurchase.POBidFlow" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table2" cellSpacing="1" cellPadding="1" width="95%" border="0" align="center">
				<TBODY>
					<TR vAlign="top">
						<TD>
							<P><uc1:UCList id="ucList_PurchaseOrder" runat="server"></uc1:UCList></UC1:UCVOUCHERLIST></P>
						</TD>
					</TR>
					<TR vAlign="top">
						<TD class="StatusLine" valign="middle">
							<asp:Label id="lblMSG" runat="server" Width="100%" Font-Bold="true" ></asp:Label>
						</TD>
					</TR>
				</TBODY>
			</TABLE>
