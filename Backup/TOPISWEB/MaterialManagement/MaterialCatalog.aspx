...
<%@ Page language="c#" Codebehind="MaterialCatalog.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.MaterialManagement.MaterialCatalog" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>MaterialCatalog</title>
		...
		function refreshTree(binID){
			window.parent.frames("MaterialCatalogTree").location="MaterialCatalogTree.aspx?NewID=" + binID;
		}	
		</script>
	</HEAD>
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE cellSpacing="1" cellPadding="1" width="95%" border="0" align="center">
				<TBODY>
					<TR vAlign="top">
						<TD>
							<P><uc1:UCList id="ucList_Catalog" runat="server"></uc1:UCList></P>
						</TD>
					</TR>
					<TR vAlign="top">
