<%@ Page language="c#" Codebehind="CancelPreserveEdit.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.WareHouse.WareHouseOperation.Preserve.CancelPreserveEdit" %>
...
<%@ Register TagPrefix="uc3" TagName="UCEdit" Src="../../../UserControls/UCEdit.ascx" %>
<%@ Register TagPrefix="uc2" TagName="ChildEditControl" Src="../../../UserControls/ChildEditControl.ascx" %>
<%@ Register TagPrefix="uc4" TagName="AttachmentManager" Src="../../../UserControls/AttachmentManager.ascx" %>
<%@ Register TagPrefix="uc1" TagName="ApproveStateInfo" Src="../../../UserControls/ApproveStateInfo.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>CancelPreserveEdit</title>
						...
						<TD style="HEIGHT: 55px"></FONT><msp:tabcontrol id="TabControl1" runat="server" BorderColor="Red" BackColor="#FF8080" Width="800px">
								<msp:TabPage ID="tabPage1">
									<TABLE id="Tbl1" cellSpacing="1" cellPadding="1" width="100%" border="0" align="center">
										...
										<TR vAlign="top">
											<TD>
												<uc3:ucedit runat="server" ID="ucList_CancelPreserve"></uc3:ucedit>
											</TD>
										</TR>
										<tr><td height="30"></td></tr>
										<tr>
											<td align="center">
												<uc4:AttachmentManager runat="server" ID="AttachmentManager1"></uc4:AttachmentManager></td>
										</tr>
									</TABLE>
								</msp:TabPage>
								<msp:TabPage ID="tabPage2">
									<TABLE id="Tbl3" cellSpacing="1" cellPadding="1" width="100%" border="0" align="center">
									    ...
									    <TR vAlign="top">
											<TD>
												<uc2:ChildEditControl runat="server" ID="Child_PreserveMaterial"></uc2:ChildEditControl>
											</TD>
										</TR>
									</TABLE>
								</msp:TabPage>
