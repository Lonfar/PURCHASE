...
<%@ Page language="c#" Codebehind="DirectArrivalMaterialEdit.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.WareHouse.WareHouseOperation.DirectArrivalMaterialEdit" %>
							...
							<msp:tabcontrol id="TabControl1" runat="server" BorderColor="Red" BackColor="#FF8080" Width="800px">
								<msp:TabPage ID="tabPage1">
									<TABLE id="Tblucvoucheredit" cellSpacing="1" cellPadding="1" width="100%" border="0" align="center">
										<tr>
											<td align="right">
												<asp:Button ID="btnIssueSubmit" Runat="server" CausesValidation="False"></asp:Button>
												<asp:Button ID="btnIssueCancel" Runat="server" CausesValidation="False"></asp:Button>
											</td>
										</tr>
										<TR vAlign="top">
											<TD align="center">
												<uc1:ucedit runat="server" ID="ucEdit_Direct"></uc1:ucedit>
											</TD>
										</TR>
										<tr>
											<td height="25"></td>
								...
								<msp:TabPage ID="tabPage3">
									<TABLE id="Tblucvoucheredit" cellSpacing="2" cellPadding="2" width="99%" border="0" align="center">
										<tr>
											<td align="right">
										...
										<TR vAlign="top" align="center">
											<TD align="center" width="95%" colspan="2">
												<uc1:ChildEditControl id="CEdit_DirectMaterial" runat="server"></uc1:ChildEditControl>
											</TD>
										</TR>
									</TABLE>
								</msp:TabPage>
								<msp:TabPage ID="tabPage4">
									<TABLE id="tb2" cellSpacing="1" cellPadding="1" width="100%" border="0" align="center">
										<tr>
											<td>
												<uc1:ChildEditControl id="CEdit_DirectOSD" runat="server"></uc1:ChildEditControl>
											</td>
										</tr>
									</TABLE>
								</msp:TabPage>
