...
<%@ Page language="c#" Codebehind="TransferDEP2DEPEdit.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.WareHouse.WareHouseOperation.Transfer.TransferDEP2DEPEdit" %>
...
<HTML>
	<HEAD>
		<title>TransferDEP2DEPEdit</title>
						...
						<TD style="HEIGHT: 55px"></FONT><msp:tabcontrol id="TabControl1" runat="server" BorderColor="Red" BackColor="#FF8080" Width="800px">
								<msp:TabPage ID="tabPage1">
									<TABLE id="Tbl1" cellSpacing="1" cellPadding="1" width="100%" border="0" align="center">
										...
										<TR vAlign="top">
											<TD>
												<uc1:ucedit runat="server" ID="ucEdit_TransferDEP"></uc1:ucedit>
											</TD>
										</TR>
										<tr>
											<td height="30"></td>
								...
								<msp:TabPage ID="tabPage2">
									<TABLE id="Tbl3" cellSpacing="1" cellPadding="1" width="100%" border="0" align="center">
										...
										<TR vAlign="top">
											<TD>
												<uc1:ChildEditControl runat="server" ID="Child_TransferDEP2DEP"></uc1:ChildEditControl>
											</TD>
										</TR>
									</TABLE>
								</msp:TabPage>
