...
<%@ Page language="c#" Codebehind="DirectArrivalMaterial.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.WareHouse.WareHouseOperation.DirectArrivalMaterial" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>TenderEvaluation</title>
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table2" cellSpacing="1" cellPadding="1" width="95%" border="0" align="center">
				<TBODY>
					<TR vAlign="top">
						<TD>
							<P><uc1:UCList id="ucList_Direct" runat="server"></uc1:UCList></P>
						</TD>
					</TR>
					<TR vAlign="top">
