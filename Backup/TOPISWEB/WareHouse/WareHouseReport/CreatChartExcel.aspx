<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreatChartExcel.aspx.cs" Inherits="TopisWeb.WareHouse.WareHouseReport.CreatChartExcel" %>
		...
		<asp:HiddenField runat="server" ID="hidDocumentValue"  />
			...
			<TABLE id="Table2" cellSpacing="1" cellPadding="1" width="95%" border="0" align="center">
				<TBODY>
					<TR vAlign="top">
						<TD>
							<iframe width="800px" scrolling="auto" runat="server" id="tableFrame" height="600px" ></iframe>
						</TD>
					</TR>
					<TR vAlign="top">
