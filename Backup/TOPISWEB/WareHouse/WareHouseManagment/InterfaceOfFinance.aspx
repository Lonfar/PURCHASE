...
<%@ Page language="c#" Codebehind="InterfaceOfFinance.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.WareHouse.WareHouseManagment.InterfaceOfFinance" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>InterfaceOfFinance</title>
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="95%" border="0" align="center">
				<TBODY>
					<TR vAlign="top">
						<TD colSpan="4">
							<P><uc1:uceditsearch id="UCEditSearch" runat="server"></uc1:uceditsearch></P>
						</TD>
					</TR>
					<TR vAlign="top">
						<TD>
							<P><uc2:UCList id="ucList_Interface" runat="server"></uc2:UCList></P>
						</TD>
					</TR>
					<TR vAlign="top">
