...
<%@ Page language="c#" Codebehind="POMaterialRemarks_Edit.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.WarehouseManagement.POMaterialRemarks_Edit" %>
					...
					<TD style="HEIGHT: 55px"></FONT><msp:tabcontrol id="TabControl1" runat="server" BorderColor="Red" BackColor="#FF8080" Width="800px">
							<msp:TabPage ID="tabPage1">
								<TABLE id="Tblucvoucheredit" cellSpacing="1" cellPadding="1" width="100%" border="0" align="center">
									<TR vAlign="top">
										<TD align="center">
											<uc1:ChildEditControl runat="server" ID="ChildPOMaterial"></uc1:ChildEditControl>
										</TD>
									</TR>
								</TABLE>
							</msp:TabPage>
