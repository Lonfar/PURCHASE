<%@ Page language="c#" Codebehind="DocumentModelCategory.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.DocumentManagement.DocumentModelCategory" %>
...
<HTML>
	<HEAD>
		<title>DocumentModelCategory</title>
		...
		function refreshTree(sNodeID){
			window.parent.frames("BidderCategoryTree").location="DocumentModelCategoryTree.aspx?NodeID=" + sNodeID;
		}				
		</script>
	</HEAD>
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE cellSpacing="1" cellPadding="1" width="95%" border="0" align="center">
				<TBODY>
					<TR vAlign="top">
						<TD>
							<P><uc1:UCList id="ucList_DocumentModelCategory" runat="server"></uc1:UCList></P>
						</TD>
					</TR>
					<TR vAlign="top">
