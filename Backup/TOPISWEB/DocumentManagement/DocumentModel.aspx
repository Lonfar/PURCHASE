<%@ Page language="c#" Codebehind="DocumentModel.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.DocumentManagement.DocumentModel" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE cellSpacing="1" cellPadding="1" width="95%" border="0" align="center">
				<TBODY>
					<TR vAlign="top">
						<TD>
							<P><uc1:UCList id="ucList_DocumentModel" runat="server"></uc1:UCList></P>
						</TD>
					</TR>
					<TR vAlign="top">
