<%@ Page language="c#" Codebehind="ServiceRequisitionEdit.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.TenderOperation.ServiceRequisitionEdit" %>
							...
							<msp:tabcontrol id="TabControl1" runat="server" BorderColor="Red" BackColor="#FF8080" Width="800px">
								<MSP:TABPAGE id="tabPage1">
									<TABLE id="Tblucvoucheredit" cellSpacing="1" cellPadding="1" width="100%" align="center"
										...
										<TR vAlign="top">
											<TD align="center">
												<UC1:UCEDIT id="ucEdit_ServiceRequistion" runat="server"></UC1:UCEDIT>
											</TD>
										</TR>
										<TR>
											<TD height="25"></TD>
									...
									<TABLE id="Tblucvoucheredit" cellSpacing="2" cellPadding="2" width="99%" align="center"
										...
										<TR vAlign="bottom" align="center">
											<TD align="center" width="95%" colSpan="2">
												<UC1:CHILDEDITCONTROL id="CEdit_ServiceRequistion" runat="server"></UC1:CHILDEDITCONTROL>
											</TD>
										</TR>
									</TABLE>
								</MSP:TABPAGE>
