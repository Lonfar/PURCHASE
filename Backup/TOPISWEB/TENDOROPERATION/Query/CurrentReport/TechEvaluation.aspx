...
<%@ Page language="c#" Codebehind="TechEvaluation.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.TENDOROPERATION.Query.CurrentReport.TechEvaluation" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>TechEvaluation</title>
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="95%" border="0" align="center">
				<TBODY>					
					<TR vAlign="top">
						<TD>
							<P><uc2:UCList id="ucList_TechEvaluation" runat="server"></uc2:UCList></P>
						</TD>
					</TR>
					<TR vAlign="top">
