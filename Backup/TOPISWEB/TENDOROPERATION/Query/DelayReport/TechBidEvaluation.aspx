...
<%@ Page language="c#" Codebehind="TechBidEvaluation.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.TENDOROPERATION.Query.DelayReport.TechBidEvaluation" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="95%" border="0" align="center">
				<TBODY>
					...
					<TR vAlign="top">
						<TD>
							<P><uc2:UCList id="ucList_ITBIssue" runat="server"></uc2:UCList></P>
						</TD>
					</TR>
					<TR vAlign="top">
