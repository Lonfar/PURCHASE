<%@ Page language="c#" Codebehind="ContractType.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.ProcurementManagement.ContractDataBase.ContractType" %>
  ...
  <head>
    ...
    <meta name=vs_targetSchema content="http://schemas.microsoft.com/intellisense/ie5">
		...
		function refreshTree(sNodeID){
			window.parent.frames("ContractTypeTree").location="ContractTypeTree.aspx?NodeID=" + sNodeID;
		}				
		</script>
  </head>
