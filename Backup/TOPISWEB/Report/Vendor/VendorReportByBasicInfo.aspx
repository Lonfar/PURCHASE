...
<%@ Page language="c#" Codebehind="VendorReportByBasicInfo.aspx.cs" AutoEventWireup="false" Inherits="TopisWeb.Report.Vendor.VendorReportByBasicInfo" %>
	...
	<body MS_POSITIONING="FlowLayout">
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="80%" align="center" border="0">
				...
				<tr vAlign="top">
					<td align="center" colSpan="4"><uc1:crystalreportbar id="PrintBar" runat="server" width="80%" ReportViewer="CrystalReportViewer1"></uc1:crystalreportbar></td>
				</tr>
				<tr valign="top">
