...
<%@ Page language="c#" Codebehind="MaterialCode.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.MaterialManagement.MaterialCode" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>MaterialCode</title>
		...
		function refreshTree(sNodeID){
			window.parent.frames("MaterialCodeTree").location="MaterialCodeTree.aspx?NodeID=" + sNodeID;
		}	
		</script>
	</HEAD>
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE cellSpacing="1" cellPadding="1" width="95%" border="0" align="center">
				<TBODY>
					<TR vAlign="top">
						<TD>
							<P><uc1:UCList id="ucList_MaterialCode" runat="server"></uc1:UCList></P>
						</TD>
					</TR>
					<TR vAlign="top">
