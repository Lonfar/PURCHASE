<%@ Page language="c#" Codebehind="ContractEdit.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.ProcurementManagement.ContractDatabase.ContractEdit" %>
						...
						<TD style="HEIGHT: 55px"></FONT><msp:tabcontrol id="TabControl1" runat="server" Width="800px" BackColor="#FF8080" BorderColor="Red">
								<MSP:TABPAGE id="tabPage1">
									<TABLE id="Tblucvoucheredit" cellSpacing="1" cellPadding="1" width="100%" align="center"
										...
										<TR vAlign="top">
											<TD align="center">
												<UC1:UCEDIT id="ucEdit_Contract" runat="server"></UC1:UCEDIT>
											</TD>
										</TR>
										<TR>
											<TD height="25"></TD>
