<%@ Page language="c#" Codebehind="SDT.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.MaterialPurchase.SDT" %>
...
<HTML>
	...
	<table id="ToolBarTable" cellSpacing="0" cellPadding="0" width="1500px" border="0" class="TopToolBarLine" >
	    <tr>
		    <td width="10"></td>
		    <td><msp:toolbar id="Toolbar1" runat="server" DESIGNTIMEDRAGDROP="58"></msp:toolbar></td>
	    </tr>
	</table>	
	<table id="UCListTable" cellSpacing="1" cellPadding="1" width="1500px" border="0" align="center">
		<tr vAlign="top">
			<td>
