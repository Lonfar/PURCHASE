...
<%@ Page language="c#" Codebehind="ImportantMaterialFinancingUseAnalysis.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.Statistic.ImportantMaterialFinancingUseAnalysis" %>
	...
	<body MS_POSITIONING="FlowLayout">
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="4" cellPadding="4" width="100%" align="center" border="0">
				...
				<tr vAlign="top" width="80%">
					<td align="left" width="800" colSpan="4"><CR:CRYSTALREPORTVIEWER id="CrystalReportViewer1" runat="server" BorderStyle="Ridge" Width="350px" AutoDataBind="true"
