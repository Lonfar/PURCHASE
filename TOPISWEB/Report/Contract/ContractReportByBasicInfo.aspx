...
<%@ Page language="c#" Codebehind="ContractReportByBasicInfo.aspx.cs" AutoEventWireup="false" Inherits="TopisWeb.Report.Vendor.ContractReportByBasicInfo" %>
	...
	<body MS_POSITIONING="FlowLayout">
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="95%" align="center" border="0">
				<TR vAlign="top">
					<TD align="center" colSpan="4"><uc1:uceditsearch id="UCEditSearch1" runat="server"></uc1:uceditsearch></TD>
				</TR>
				<tr vAlign="top" width="80%">
					<td class="FormNormalTitle" align="right" style="WIDTH:15%" colSpan="1"><asp:literal id="Literal_From" runat="server"></asp:literal></td>
					<td class="SingleLineTextBox" style="WIDTH:35%" colSpan="1" align="left">
						<cc2:DatePicker id="DateEditor_From" runat="server" width="100%"></cc2:DatePicker>
					</td>
					<td class="FormNormalTitle" align="right" style="WIDTH:15%" colSpan="1"><asp:literal id="Literal_To" runat="server"></asp:literal></td>
					<td class="SingleLineTextBox" style="WIDTH:35%" colSpan="1" align="left">
						<cc2:DatePicker id="DateEditor_To" runat="server" width="100%"></cc2:DatePicker>
					</td>
				</tr>
				<tr vAlign="top" width="80%">
					<td class="FormNormalTitle" align="right" style="WIDTH:15%" colSpan="1"><asp:literal id="Literal_From2" runat="server"></asp:literal></td>
					<td class="SingleLineTextBox" style="WIDTH:35%" colSpan="1" align="left">
						<cc2:DatePicker id="DateEditor_From2" runat="server" width="100%"></cc2:DatePicker>
					</td>
					<td class="FormNormalTitle" align="right" style="WIDTH:15%" colSpan="1"><asp:literal id="Literal_To2" runat="server"></asp:literal></td>
					<td class="SingleLineTextBox" style="WIDTH:35%" colSpan="1" align="left">
						<cc2:DatePicker id="DateEditor_To2" runat="server" width="100%"></cc2:DatePicker>
					</td>
				</tr>
				<tr vAlign="top">
