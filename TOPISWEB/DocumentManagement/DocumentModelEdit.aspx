<%@ Page language="c#" Codebehind="DocumentModelEdit.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.DocumentManagement.DocumentModelEdit" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="95%" border="0" align="center">
				<TBODY>
					<TR vAlign="top">
						<TD>
							<P><uc1:ucedit id="ucEdit_DocumentModel" runat="server"></uc1:ucedit></P>
						</TD>
					</TR>
					<TR vAlign="top">
						<TD>
