<%@ Page language="c#" Codebehind="TrackingEdit.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.LogisticsManagement.Process.TrackingEdit" %>
		    ...
		    <td style="HEIGHT: 55px">
		        <msp:tabcontrol id="TabControl1" runat="server" BorderColor="Red" BackColor="#FF8080" Width="100%">
                    ...
                    <table id="TABLE1" cellSpacing="1" cellPadding="1" width="100%" border="0" align="center">
							 ...
							 <tr valign="top">
									<td>
										<uc1:ChildEditControl id="ChildEdit_Status" runat="server"></uc1:ChildEditControl>											
									</td>
								</tr>  
