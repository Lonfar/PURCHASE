<%@ Page language="c#" Codebehind="WOPRTracking.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.LogisticsManagement.Process.WOPRTracking" %>
		...
		<FORM id="Form1" method="post" runat="server">
			...
			<TABLE id="Table2" cellSpacing="1" cellPadding="1" width="95%" align="center" border="0">
				<TR vAlign="top">
					<TD>
						<P>
							<uc1:UCList id="ucList_WOPRTracking" runat="server"></uc1:UCList></P>
					</TD>
				</TR>
				<TR vAlign="top">
