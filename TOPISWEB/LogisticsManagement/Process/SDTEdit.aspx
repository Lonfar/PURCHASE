<%@ Page language="c#" Codebehind="SDTEdit.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.LogisticsManagement.Process.SDTEdit" %>
		        ...
		        <msp:tabcontrol id="TabControl1" runat="server" BorderColor="Red" BackColor="#FF8080" Width="100%">
				    <msp:TabPage ID="tabPage1">
                        <table id="TABLE3" cellSpacing="1" cellPadding="1" width="100%" border="0" align="center">
                            <tr>
							    <td align="right">
						            <asp:Button ID="btnRecv" Runat="server" CausesValidation="False"></asp:Button>
							    </td>
							</tr>
							<tr vAlign="top">
								<td align="center">
