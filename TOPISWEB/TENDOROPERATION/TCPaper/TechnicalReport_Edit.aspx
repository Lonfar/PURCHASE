...
<%@ Page language="c#" Codebehind="TechnicalReport_Edit.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.TENDOROPERATION.TCPaper.TechnicalReport_Edit" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>TechnicalReport_Edit</title>
							...
							<msp:tabcontrol id="TabControl1" runat="server" BorderColor="Red" BackColor="#FF8080" Width="800px">
								<msp:TabPage ID="tabPage1">
									<TABLE id="Tblucvoucheredit1" cellSpacing="1" cellPadding="1" width="100%" border="0" align="center">
										<TR vAlign="top">
											<TD align="center">
												<uc1:ucedit runat="server" ID="ucEdit_Technical"></uc1:ucedit>
											</TD>
										</TR>
									</TABLE>
								</msp:TabPage>
