<%@ Page language="c#" Codebehind="CommEvaluation.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.TENDOROPERATION.Query.CurrentReport.CommEvaluation" %>
<%@ Register TagPrefix="cc1" Namespace="MSPlus.Web.UI.WebControls" Assembly="MSPlus.ToolBarAndMenu" %>
<%@ Register TagPrefix="uc2" TagName="UCList" Src="../../../UserControls/UCList.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>CommEvaluation</title>
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="95%" border="0" align="center">
				<TBODY>					
					<TR vAlign="top">
						<TD>
							<P><uc2:UCList id="ucList_CommEvaluation" runat="server"></uc2:UCList></P>
						</TD>
					</TR>
					<TR vAlign="top">
