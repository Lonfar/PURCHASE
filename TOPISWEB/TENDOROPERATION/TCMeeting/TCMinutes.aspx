<%@ Page language="c#" Codebehind="TCMinutes.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.TENDOROPERATION.TCMeeting.TCMinutes" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table2" cellSpacing="1" cellPadding="1" width="95%" border="0" align="center">
				<TBODY>
					<TR vAlign="top">
						<TD>
							<P><uc1:UCList id="ucList_TCMinutes" runat="server"></uc1:UCList></P>
						</TD>
					</TR>
					<TR vAlign="top">
