<%@ Page language="c#" Codebehind="Proposal_Edit.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.TENDOROPERATION.Proposal_Edit" %>
							...
							<msp:tabcontrol id="TabControl1" runat="server" BorderColor="Red" BackColor="#FF8080" Width="800px">
								<msp:TabPage ID="tabPage1">
									<TABLE id="Tblucvoucheredit1" cellSpacing="1" cellPadding="1" width="100%" border="0" align="center">
										<TR vAlign="top">
											<TD align="center">
												<uc1:ucedit runat="server" ID="ucEdit_Proposal"></uc1:ucedit>
											</TD>
										</TR>
									</TABLE>
								</msp:TabPage>
								<msp:TabPage id="tabPage2">
									<TABLE id="Tblucvoucheredit2" cellSpacing="1" cellPadding="1" width="100%" align="center"
										...
										<TR vAlign="top">
											<TD>
												<uc1:ChildEditControl id="Child_ProposalBidder" runat="server"></uc1:ChildEditControl></TD>
										</TR>
									</TABLE>
								</msp:TabPage>
