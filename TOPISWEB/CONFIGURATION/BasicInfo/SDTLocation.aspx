...
<%@ Page language="c#" Codebehind="SDTLocation.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.Configuration.BasicInfo.SDTLocation" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>SDTLocation</title>
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table2" cellSpacing="1" cellPadding="1" width="95%" border="0" align="center">
				<TBODY>
					<TR vAlign="top">
						<TD>
							<P><uc1:UCList id="ucList_SDTLocation" runat="server"></uc1:UCList></P>
						</TD>
					</TR>
					<TR vAlign="top">
