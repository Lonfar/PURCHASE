...
<%@ Page language="c#" Codebehind="BasicInfoDepartEmployee_Tree.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.Configuration.BasicInfo.BasicInfoDepartEmployee_Tree" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>BasicInfoEmployee_Tree</title>
	...
	<body MS_POSITIONING="FlowLayout"  Class="Tree_Topline">
		...
		<table border=1 cellpadding="0" cellspacing="0" width="100%" height="94%" Class="Tree_Area">
				<tr valign="top"><td>
			<iewc:TreeView id="TreeView1" runat="server" SystemImagesPath="../../images/tree/" 
