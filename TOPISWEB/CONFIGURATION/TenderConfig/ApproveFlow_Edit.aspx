<%@ Page language="c#" Codebehind="ApproveFlow_Edit.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.Configuration.TenderConfig.ConfirmerFlow_Edit" %>
				...
				<TBODY>
					...
					<tr>
						...
						<TABLE id="Table2" cellSpacing="1" cellPadding="1" width="80%" border="0" align="center">
							<tr>
								<td>
									<asp:Label ID="lbCurrency" Runat="server" CssClass="FormNormalTitle"></asp:Label>
									<asp:TextBox ID="txtCurrency" Runat="server" CssClass="SingleLineTextBox"></asp:TextBox>
								</td>
							</tr>	
						</table>
						</td>
