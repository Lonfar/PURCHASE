...
<%@ Page language="c#" Codebehind="BidderManagement_Edit.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.Bidder.BidderManagement_Edit" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>BidderManagement_Edit</title>
							...
							<msp:tabcontrol id="TabControl1" runat="server" BorderColor="Red" BackColor="#FF8080" Width="800px">
								<msp:TabPage ID="tabPage1">
									<TABLE id="Tblucvoucheredit1" cellSpacing="1" cellPadding="1" width="100%" border="0" align="center">
										<TR vAlign="top">
											<TD align="center">
												<uc1:ucedit runat="server" ID="ucEdit_BidderManagement"></uc1:ucedit>
											</TD>
										</TR>
									</TABLE>
								</msp:TabPage>
								<msp:TabPage id="tabPage2">
									<TABLE id="Tblucvoucheredit2" cellSpacing="1" cellPadding="1" width="100%" align="center"
										...
										<TR vAlign="top">
											<TD>
												<uc1:ucedit id="ucEdit_BidderPROFILE" runat="server"></uc1:ucedit></TD>
										</TR>
									</TABLE>
								</msp:TabPage>
								<msp:TabPage ID="tabPage3">
									<TABLE id="Tblucvoucheredit3" cellSpacing="1" cellPadding="1" width="100%" border="0" align="center">
										<tr>
											<td align="center">
