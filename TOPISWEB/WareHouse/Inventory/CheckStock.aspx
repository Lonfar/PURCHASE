...
<%@ Page language="c#" Codebehind="CheckStock.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.WareHouse.Inventory.CheckStock" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE cellSpacing="1" cellPadding="1" width="95%" border="0" align="center">
				<TBODY>
					<TR vAlign="top">
						<TD colSpan="4">
							<P><uc1:UCList id="ucList_CheckStock" runat="server"></uc1:UCList></P>
						</TD>
					</TR>
					<TR vAlign="top">
