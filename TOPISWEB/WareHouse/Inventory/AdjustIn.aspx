...
<%@ Page language="c#" Codebehind="AdjustIn.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.WareHouse.Inventory.AdjustIn" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>AdjustIn</title>
		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE cellSpacing="1" cellPadding="1" width="95%" border="0" align="center">
				<TBODY>
					<TR vAlign="top">
						<TD>
							<P><uc1:UCList id="ucList_AdjustIn" runat="server"></uc1:UCList></P>
						</TD>
					</TR>
					<TR vAlign="top">
