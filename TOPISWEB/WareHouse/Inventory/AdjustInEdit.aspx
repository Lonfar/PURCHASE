...
<%@ Page language="c#" Codebehind="AdjustInEdit.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.WareHouse.Inventory.AdjustInEdit" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>AdjustInEdit</title>
						...
						<msp:tabcontrol id="TabControl1" runat="server" BorderColor="Red" BackColor="#FF8080" Width="800px">
							<msp:TabPage ID="tabPage1">
								<TABLE id="Tbl1" cellSpacing="1" cellPadding="1" width="100%" border="0" align="center">
									...
									<TR vAlign="top">
										<TD>
											<uc1:ucedit id="ucEdit_AdjustIn" runat="server"></uc1:ucedit>
										</TD>
									</TR>
									<tr>
										<td height="25"></td>
							...
							<msp:TabPage ID="tabPage2">
								<TABLE cellSpacing="1" cellPadding="1" width="100%" border="0" align="center">
									...
									<TR vAlign="top">
										<TD align="center">
											<uc1:ChildEditControl id="ChildEdit_InventoryList" runat="server"></uc1:ChildEditControl>
										</TD>
									</TR>
								</TABLE>
							</msp:TabPage>
