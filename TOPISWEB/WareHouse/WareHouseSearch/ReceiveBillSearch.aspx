<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceiveBillSearch.aspx.cs" Inherits="TopisWeb.WareHouse.WareHouseSearch.ReceiveBillSearch" %>
...
<head runat="server">
	...
	<script language="javascript">
		function search()
		{
			...
			window.parent.frames("RefContent").location='ReceiveBillReport.aspx?POID='+document.getElementById("Ref_PO_txtRefID").value ;
			
			// +'&VendorID='+document.getElementById("Ref_Vendor_txtRefID").value+'&DepID='+document.getElementById("Ref_Dept_txtRefID").value
		}	
	</script>
</head>
<body>
					...
					<TR vAlign="top">
						<TD colSpan="4">
							<TABLE class="SearchTableArea"  width="90%" cellSpacing="1" cellPadding="1" align="left" border="0">
								<TR>
									<TD class="FormNormalTitle" style="WIDTH: 10%" align="left">
										<asp:Label id="lblPO" runat="server"></asp:Label></TD>
									<TD>
										<uc1:RefEditor id="Ref_PO" runat="server"></uc1:RefEditor></TD>
									<TD>&nbsp;</TD>
									<!--
									<TD class="FormNormalTitle" style="WIDTH: 10%" align="left">
										<asp:Label id="lblVendor" runat="server"></asp:Label></TD>
									<TD>
										<uc1:RefEditor id="Ref_Vendor" runat="server"></uc1:RefEditor></TD>
									<TD>&nbsp;</TD>
									<TD class="FormNormalTitle" style="WIDTH: 10%" align="left">
										<asp:Label id="lblDept" runat="server"></asp:Label></TD>
									<TD>
										<uc1:RefEditor id="Ref_Dept" runat="server"></uc1:RefEditor></TD>-->
