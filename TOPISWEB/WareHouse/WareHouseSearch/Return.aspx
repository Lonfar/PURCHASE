...
<%@ Page language="c#" Codebehind="Return.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.Report.WareHouse.Return" %>
				...
				<FORM id="Form1" method="post" runat="server">
					<TABLE class="TopToolBarLine" id="Table2" cellSpacing="0" cellPadding="0" width="100%"
						...
						<TR>
							<TD width="10"></TD>
							<TD>
								<cc1:toolbar id="ToolBar" runat="server"></cc1:toolbar></TD>
						</TR>
					</TABLE>
