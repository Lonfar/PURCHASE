<%@ Page language="c#" Codebehind="TransferWH2WHEdit.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.WareHouse.WareHouseOperation.Transfer.TransferWH2WHEdit" %>
						...
						<TD style="HEIGHT: 55px"></FONT><msp:tabcontrol id="TabControl1" runat="server" BorderColor="Red" BackColor="#FF8080" Width="800px">
								<msp:TabPage ID="tabPage1">
									<TABLE id="Tbl1" cellSpacing="1" cellPadding="1" width="100%" border="0" align="center">
										...
										<TR vAlign="top">
											<TD>
												<uc1:ucedit runat="server" ID="ucEdit_TransferWH"></uc1:ucedit>
											</TD>
										</TR>
								...
								<msp:TabPage ID="tabPage2">
									...
									<tr>
										...
										<TR vAlign="top">
											<TD>
												<uc1:ChildEditControl runat="server" ID="Child_Material"></uc1:ChildEditControl>
											</TD>
										</TR>
								</TABLE>
								</msp:TabPage>
