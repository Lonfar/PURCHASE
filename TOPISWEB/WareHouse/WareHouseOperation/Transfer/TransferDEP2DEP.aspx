...
<%@ Page language="c#" Codebehind="TransferDEP2DEP.aspx.cs" AutoEventWireup="True" Inherits="TopisWeb.WareHouse.WareHouseOperation.Transfer.TransferDEP2DEP" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>TransferDEP2DEP</title>
	...
	<body MS_POSITIONING="FlowLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0" class="TopToolBarLine">
				<TR>
					<td width="10"></td>
					<TD><msp:toolbar id="ToolBar" runat="server" DESIGNTIMEDRAGDROP="58"></msp:toolbar></TD>
					</TD></TR>
			</TABLE>
			<TABLE id="Table2" cellSpacing="1" cellPadding="1" width="95%" border="0" align="center">
				<TBODY>
					<TR vAlign="top">
						<TD>
							<P><uc1:UCList id="ucList_TransferDEP" runat="server"></uc1:UCList></P>
						</TD>
					</TR>
					<TR vAlign="top">
